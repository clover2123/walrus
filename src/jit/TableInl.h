...
static void emitElemDrop(sljit_compiler* compiler, Instruction* instr)
{
    ...
    sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS2(V, 32, W), SLJIT_IMM, GET_FUNC_ADDR(sljit_sw, dropElement));
}
...
static void emitTable(sljit_compiler* compiler, Instruction* instr)
{
    ...
    case ByteCode::TableInitOpcode: {
        ...
        sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS4(V, 32, 32, 32, W), SLJIT_IMM, GET_FUNC_ADDR(sljit_sw, initTable));
    ...
    case ByteCode::TableCopyOpcode: {
        ...
        sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS4(V, 32, 32, 32, W), SLJIT_IMM, GET_FUNC_ADDR(sljit_sw, copyTable));
        sljit_emit_op1(compiler, SLJIT_MOV, SLJIT_R2, 0, SLJIT_R0, 0);
        sljit_set_label(sljit_emit_cmp(compiler, SLJIT_NOT_EQUAL, SLJIT_R0, 0, SLJIT_IMM, ExecutionContext::NoError), context->trapLabel);
        break;
    }
    case ByteCode::TableFillOpcode: {
        ...
        sljit_emit_icall(compiler, SLJIT_CALL, SLJIT_ARGS4(V, 32, P, 32, W), SLJIT_IMM, GET_FUNC_ADDR(sljit_sw, fillTable));
        sljit_emit_op1(compiler, SLJIT_MOV, SLJIT_R2, 0, SLJIT_R0, 0);
        sljit_set_label(sljit_emit_cmp(compiler, SLJIT_NOT_EQUAL, SLJIT_R0, 0, SLJIT_IMM, ExecutionContext::NoError), context->trapLabel);
        break;
    }
